...
let out = '';
out += '=== AI 创业 (11087:7488) ===\\n';
out += extractDetails(findNodeById(canvas, '11087:7488'));
out += '\\n=== 英语学习 (11087:7503) ===\\n';
out += extractDetails(findNodeById(canvas, '11087:7503'));

fs.writeFileSync('figma_details.txt', out);
