...
let out = '';
out += '=== AI 创业 (11108:7551) ===\\n';
out += extractDetails(findNodeById(canvas, '11108:7551'));
out += '\\n=== chat (11108:7568) ===\\n';
out += extractDetails(findNodeById(canvas, '11108:7568'));

fs.writeFileSync('figma_details_2.txt', out);
